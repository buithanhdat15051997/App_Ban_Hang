...
public class LaptopAdapter extends BaseAdapter {
    ...
    public LaptopAdapter(Context contextDT, ArrayList<SanPhamMoiNhat> arrayList) {
        this.contextLT = contextDT;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            LayoutInflater layoutInflater = (LayoutInflater) contextLT.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        Picasso.with(contextLT).load(sanPhamMoiNhat.getHinhanhSPNew()).placeholder(R.drawable.noimage).error(R.drawable.imgerror)
